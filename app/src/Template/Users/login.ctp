    ...
    <article class="container-login center-block">
        <section>
            <ul id="top-bar" class="nav nav-tabs nav-justified">
                ...
                <li><?= $this->Html->link('Recuperar Password', ['controller' => '#', 'action' => '#']) ?></li>
            </ul>
...
<!--                        <div class="checkbox">
                        ...
                        <br/>
                        <div class="form-group ">
                            <?= $this->Form->button('Acceder',['class' => 'btn btn-lg btn-primary']) ?>
                            <br />
                            <?= $this->Html->link('Registrarse', ['controller' => 'users', 'action' => 'add'], ['class' => 'btn btn-lg btn-primary', 'style' => 'width: 100%; border-radius: 0; padding: 10px 16px; margin-top: 5px;']) ?>
